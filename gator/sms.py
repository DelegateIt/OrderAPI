...
from gator.models import Model, Customer, CFields, Transaction, TFields, MTypes
from gator.common import TransactionStates, Platforms
from gator.auth import validate_permission, Permission, validate_token
...
def get_sms_transaction(customer_uuid):
    ...
    transaction = bl.create_transaction({
...
def handle_sms():
    ...
    bl.send_message(transaction, request.values["Body"], True, MTypes.TEXT)
